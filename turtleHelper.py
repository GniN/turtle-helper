...
class PTTThread(QThread):
    ...
    def giveDifferentMoney(self, receivers_and_amount, edit_bag, title, content, anonymous):
        ...
        for id_and_amount in receivers_and_amount:
            try:
                ...
                self.pttErrCode = self.ptt_bot.give_money(id, int(amount), title, content, anonymous)
    ...
    def giveMoney(self, amount, receivers, edit_bag, title, content, anonymous):
        self.progress.emit(0)
        idx = 0
        for id in receivers:
...
class App(QMainWindow):
    ...
    def sendMoney(self):
        ...
        anonymous_bag = self.widget.anonymous_red_bag_checkbox.isChecked()
...
class MainWidget(QWidget):
    ...
    def createGiveMoneyUI(self):
        ...
        self.anonymous_red_bag_checkbox = QCheckBox('是否匿名(小天使功能)')
        ...
        edit_bag_form.addRow(self.anonymous_red_bag_checkbox)
